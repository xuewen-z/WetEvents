...
PathResRec     = '../output/Threshold_08/06_ResRec17GPP/';
...
% ===============================
% SPEI 与湿润等级（敏感性测试：下限 1.0 -> 0.8）
% ===============================
SPEIName   = 'spei03';
LevelList  = {[0.8,1.5], [1.5,2.0], [2.0,inf]};
