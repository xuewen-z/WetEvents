...
PathTrendSen   = '../output/10_TrendSenResRec/';   % ★ 趋势结果
Path_Figure    = '../figure/';
...
% 读取 Sensitivity 趋势结果
% ===============================
load([PathTrendSen,'TrendSlopeSen.mat']);  
% SlopeSen, PSen

Class = SlopeSen;   % ★ 主图变量：Sen's slope
Pval  = PSen;
...
Thres1 = -0.06;
Thres2 =  0.06;
IndName = 'sen''s slope of sensitivity (2001–2022)';
...
Pos = [Pos(1)+0.55 Pos(2)+0.03 Pos(3)*0.35 Pos(4)*2/3];
set(Hbar,'Position',Pos,'FontSize',16);
set(Hbar,'XLim',[Thres1 Thres2]);
set(Hbar,'XTick',Thres1:0.03:Thres2);
TickLabel = cellstr(num2str(get(Hbar,'XTick')','%.2f'));
TickLabel{1} = '<-0.06';
TickLabel{end} = '>0.06';
...
text('String',IndName,'Units','Normalized',...
     'Position',[0.57 0.14],'FontSize',16);
