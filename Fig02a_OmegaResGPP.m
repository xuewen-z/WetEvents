...
PathSumRes     = '../output/08_SumRes17GPP/';
Path_Figure    = '../figure/';
...
% 读取多年平均总敏感性
% ===============================
load([PathSumRes,'Climatology/ResClim.Total.mat']);
% ResClimTotal (nRow × nCol)
...
ResVals = ResClimTotal;
ResVals(LandCover == 0 | LandCover == 11 | LandCover == 13 | ...
...
% 区间定义
% ===============================
BinEdges  = [0 10 20 30 40 inf];
BinLabels = {'(0,10]','(10,20]','(20,30]','(30,40]','>40'};

% ===============================
% 面积占比
% ===============================
[counts,~] = histcounts(ResVals, BinEdges);
...
print(Fig, '-dtiff', '-r300', [Path_Figure, 'ResGPPTotal.tif']); close(Fig);
