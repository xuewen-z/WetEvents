...
% ===============================
PathSen = '../output/Threshold_08/05_Sen17GPP/';      % 输入：YrGPPSen.*
PathOut = '../output/Threshold_08/07_SumSen17GPP/';   % 输出：汇总结果
...
disp('Finished: aggregation & climatology. (Threshold_08, SPEI-03 >= 0.8)');
