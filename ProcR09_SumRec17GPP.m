...
% 路径设置（Recovery）
% ===============================
PathRec = '../output/Threshold_08/06_ResRec17GPP/';     % 输入：YrGPPRec.*
PathOut = '../output/Threshold_08/09_SumRec17GPP/';     % 输出：汇总结果
...
disp('Finished: Recovery aggregation & climatology. (Threshold_08, SPEI-03 >= 0.8)');
