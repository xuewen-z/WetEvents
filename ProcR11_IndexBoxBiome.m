% ===============================================================
% ProcR11_IndexBoxBiome.m
% ---------------------------------------------------------------
% 阈值敏感性分析 (Threshold sensitivity test)
%   使用阈值 : SPEI-03 >= 0.8   (对照原基准 SPEI-03 >= 1.0)
%   对应原始脚本 : Proc11_IndexBoxBiome.m
%   测试目的 : 基于 ProcR07/ProcR08/ProcR09 (SPEI>=0.8) 的气候态
%              结果，按 14 个生物群系提取 Sensitivity/Resistance/
%              Resilience 的箱线图数据，用于检验不同阈值下各
%              生态系统间相对差异是否保持一致。计算逻辑与
%              Proc11 完全一致，仅输入/输出路径重定向。
%   输出目录 : ../output/Threshold_08/11_IndexBoxBiome/
% ===============================================================
...
Path_Boxdata   = '../output/Threshold_08/11_IndexBoxBiome/';
