...
% 路径设置（Resistance）
% ===============================
PathRes = '../output/Threshold_12/06_ResRec17GPP/';     % 输入：YrGPPRes.*
PathOut = '../output/Threshold_12/08_SumRes17GPP/';     % 输出：汇总结果
...
disp('Finished: Resistance aggregation & climatology. (Threshold_12, SPEI-03 >= 1.2)');
